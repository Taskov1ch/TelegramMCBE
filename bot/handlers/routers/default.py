...
vk_api = API(token = getenv("VK_TOKEN"))

@rt.get("/vkconnector/try_link", dependencies = [Depends(verify_secret)])
...
@rt.get("/vkconnector/linked_players", dependencies = [Depends(verify_secret)])
...
# curl -X GET "http://localhost:8000/vkconnector/linked_players" -H "accept: application/json" -H "Authorization: Bearer $2a$12$8DMPnX./VDEhyeIAplo75O0q6maF0bpXUo/eziXvIS73VWbzAIWc."
